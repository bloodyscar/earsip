...
if (isset($_POST['gantipass'])) {
    ...
    if ($cek_pass > 0) {
        ...
        window.location='document_masuk'</script>";
    }
}
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h4>Document Masuk</h4>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class='breadcrumb-header'>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Document Masuk</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<a style="font-size: 6pt;" href="document_keluar?aksi=hapus&id" onclick="return confirm('Yakin Ingin hapus Document ini ?')" class="btn icon btn-danger">
